...
namespace ASG
{
    public partial class frm_menu : Form
    {
        ...
        public frm_menu(frm_loggin previo, string name, string rol, string user, PictureBox image, bool[] privilegio)
        {
            InitializeComponent();
            nameUser = name;
            ...
            timer2.Interval = 600;
            timer2.Enabled = true;
           /* vScrollBar1.Maximum = panel4.Size.Height - panel5.Size.Height; // este coidgo movia los scroll del menu pero ya se mejoro la funcion
        ...
        {
            frm_clientes frm = new frm_clientes(nameUser, rolUser, userName, idSucursal, false, null, null);
            frm.Show(); 
        }
        private void button3_Click(object sender, EventArgs e)
        {
            frm_proveedores frm = new frm_proveedores(nameUser, rolUser, userName,0,idSucursal,false);
            frm.Show();
        }
        ...
        {
            frm_comprasM frm = new frm_comprasM(nameUser, rolUser, userName, idSucursal, privilegios);
            frm.Show();
        }
        ...
        {
            frm_cuentasCobrar frm = new frm_cuentasCobrar(nameUser, rolUser, userName, idSucursal, codigoCaja, privilegios, nombreSucursal);
            frm.Show();
        }
        ...
        {
            var forma = new frm_BuscaProducto(nombreSucursal, idSucursal, rolUser, label2.Text,pictureBox1, userName);
            forma.ShowDialog();
        }
        ...
        {
            var fomra = new frm_gastos(nameUser, rolUser, userName, nombreSucursal);
            fomra.ShowDialog();
        }
        ...
        {
            var forma = new frm_recetas();
            forma.ShowDialog();
        }

        private void button23_Click(object sender, EventArgs e)
        {
            // formjlario para poder editar y gesionar toda a materia prima
            frm_materiaPrima frm = new frm_materiaPrima(nameUser, rolUser, userName, idSucursal, nombreSucursal);
            frm.Show();
        }
        ...
        {
            var forma = new frm_AreasProduccion(nameUser, rolUser, userName, idSucursal, nombreSucursal);
            forma.ShowDialog();
        }
        private void button27_Click(object sender, EventArgs e)
        {
            ofertaDeVentas frm = new ofertaDeVentas(nameUser, rolUser, userName, idSucursal, nombreSucursal, privilegios);
            frm.Show();
        ...
        {
            ordenProduccion frm = new ordenProduccion(nameUser, rolUser, userName, idSucursal, nombreSucursal);
            frm.Show();
        }

        private void button28_Click(object sender, EventArgs e)
        {
            produccion frm = new produccion(nameUser, rolUser, userName, idSucursal, nombreSucursal);
            frm.Show();
        }
    }
}
