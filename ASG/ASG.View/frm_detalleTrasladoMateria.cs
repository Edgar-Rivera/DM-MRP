...
namespace ASG
{
    public partial class frm_detalleTrasladoMateria : Form
    {
        Point DragCursor;
        Point DragForm;
        bool Dragging;

        public frm_detalleTrasladoMateria(string codigo, string usuario, string origen, string destino, string fecha)
        {
            InitializeComponent();
            label7.Text = codigo;
            label8.Text = usuario;
        ...
        private void cargaDetalle(string codigo)
        {
            ...
            try
            {
                ...
                string sql = string.Format("SELECT * FROM VISTA_DETALLE_TRASLADO_MATERIA WHERE ID_TRASLADO = {0};", codigo);
        ...
        private void frm_detalleTrasladoMateria_MouseDown(object sender, MouseEventArgs e)
        {
            Dragging = true;
        ...
        private void frm_detalleTrasladoMateria_MouseMove(object sender, MouseEventArgs e)
        {
            if (Dragging == true)
            {
        ...
        private void frm_detalleTrasladoMateria_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            CrystalReportTrasladoMateria cr = new CrystalReportTrasladoMateria();
        ...
        private void frm_detalleTrasladoMateria_Load(object sender, EventArgs e)
        {
