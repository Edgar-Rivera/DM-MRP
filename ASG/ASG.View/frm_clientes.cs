...
namespace ASG
{
    public partial class frm_clientes : Form
    {
        ...
        bool Dragging;
        bool indexer;
        public frm_clientes(string nameUser, string rolUser, string user, string sucursal, bool index, string nit, string nombre)
        {
            InitializeComponent();
            usuario = user;
            nameUs = nameUser;
        ...
        private void my_menu_Itemclicked(object sender, ToolStripItemClickedEventArgs e)
        {
            if (flag == false)
            {
                ...
                else if (e.ClickedItem.Name == "ColEdit")
                {
                    ...
                    pictureBox5.Image = Properties.Resources.checked2;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (textBox2.Text != "" | textBox3.Text != "" | textBox4.Text != "" | textBox5.Text != "" | textBox6.Text != "" | textBox7.Text != "")
            {
                ...
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    label30.Text = "Se utilizara en el envío";*/
        ...
        private bool codigoCliente(string codigo)
        {
            OdbcConnection conexion = ASG_DB.connectionResult();
            try
            {
                string sql = string.Format("SELECT CODIGOCLIENTE FROM CLIENTE WHERE CODIGOCLIENTE = {0};", codigo);
                OdbcCommand cmd = new OdbcCommand(sql, conexion);
                OdbcDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
        ...
        private void guardaEfectivo()
        {
                    ...
                    if (textBox2.Text != "" & textBox3.Text != "" & textBox5.Text != "" & textBox16.Text != "" & comboBox1.Text != "" & textBox7.Text != ""  )
                    {
                        try
                        {
                            OdbcConnection conexion = ASG_DB.connectionResult();
        ...
        private void guardaCredito()
        {
                    ...
                    if (textBox2.Text != "" & textBox3.Text != "" & textBox5.Text != "" & textBox6.Text != "" & comboBox1.Text != "" & textBox7.Text != ""  )
                    {
                        try
                        {
                            OdbcConnection conexion = ASG_DB.connectionResult();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (forma.DialogResult == DialogResult.OK)
            {
                ...
                if (textBox10.Text != "")
                {
                    ...
                    textBox7.Focus();
                    ////pictureBox6.Image = ASG.Properties.Resources.checked2;
                    //pictureBox5.Image = ASG.Properties.Resources.checked2;
                }
            }
        }
        ...
        private bool codigoRepetidoCliente(string code)
        {
            OdbcConnection conexion = ASG_DB.connectionResult();
            try
            {
                string sql = string.Format("SELECT CODIGOCLIENTE FROM CLIENTE WHERE CODIGOCLIENTE =  '{0}' AND ESTADO_TUPLA = TRUE;", code);
                OdbcCommand cmd = new OdbcCommand(sql, conexion);
                OdbcDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
            ...
            if (textBox10.Text != "" | textBox9.Text != "" | textBox12.Text != "" | textBox8.Text != "" | textBox11.Text != "" | textBox17.Text != "" | textBox13.Text != "")
            {
                ...
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                   ...
                   // textBox20.BackColor = Color.White;
                    ...
                    //label29.Text = "Se utilizara en el envío";
                    cargaTipos();
                }
            }
        }
        private void editaEfectivo()
        {
            ...
            if (textBox10.Text != "" & textBox9.Text != ""  & textBox8.Text != "" & textBox11.Text != "" & comboBox2.Text != "" & textBox13.Text != "" & textBox17.Text != "" )
            {
                try
                {
                    OdbcConnection conexion = ASG_DB.connectionResult();
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (dataGridView1.RowCount > 0)
            {
                var forma = new frm_balanceCliente(dataGridView1.CurrentRow.Cells[1].Value.ToString(), dataGridView1.CurrentRow.Cells[2].Value.ToString(), dataGridView1.CurrentRow.Cells[5].Value.ToString(), dataGridView1.CurrentRow.Cells[6].Value.ToString(), dataGridView1.CurrentRow.Cells[7].Value.ToString(), dataGridView1.CurrentRow.Cells[0].Value.ToString());
                forma.ShowDialog();
            }
        }
        ...
        private void button6_Click_2(object sender, EventArgs e)
        {
           if(textBox14.Text != "")
            {
                DialogResult result;
                result = MessageBox.Show("¿ESTA SEGURO QUE DESEA MODIFICAR EL NIT DEL CLIENTE?", "EDICION CLIENTE", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    bool codex = true;
                    while (codex)
            ...
            {
                MessageBox.Show("AUN NO HA SELECCIONADO UN CLIENTE!", "EDICION CLIENTE", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
           ...
           /* if(textBox19.Text != "")
            {
                ...
                try
                {
                    string sql = string.Format("SELECT CODIGOCLIENTE FROM CLIENTE WHERE CODIGOCLIENTE = {0};", textBox19.Text);
                    OdbcCommand cmd = new OdbcCommand(sql, conexion);
                    OdbcDataReader reader = cmd.ExecuteReader();
                    if (reader.Read())
                    {
                       
                        label30.Text = "El código asignado ya existe";
                        pictureBox2.Visible = true;
                        pictureBox2.Image = ASG.Properties.Resources.delete__2_;
                    }
                    else
                    {
                        ...
                        label30.Text = "Se utilizara en el envío";
                        pictureBox2.Visible = true;
                        pictureBox2.Image = ASG.Properties.Resources.checked2;
                    }
                }
                catch (Exception ex)
                {
           ...
           /* if (textBox20.Text != "")
            {
                ...
                try
                {
                    string sql = string.Format("SELECT CODIGOCLIENTE FROM CLIENTE WHERE CODIGOCLIENTE = {0};", textBox20.Text);
                    OdbcCommand cmd = new OdbcCommand(sql, conexion);
                    OdbcDataReader reader = cmd.ExecuteReader();
                    if (reader.Read())
                    {
                        //pictureBox6.Visible = true;
                        //pictureBox6.Image = ASG.Properties.Resources.delete__2_;
                        //label29.Text = "El código asignado ya existe";
                    }
                    else
                    {
                        //pictureBox6.Visible = true;
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult result;
                result = MessageBox.Show("¿ESTA SEGURO QUE DESEA MODIFICAR EL CODIGO DEL CLIENTE?", "EDICION CLIENTE", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    bool codex = true;
                    while (codex)
                    {
                        string temp = createCodeInt(6);
                        if (codigoRepetidoCliente(temp))
                        {
                           //textBox20.Text = temp;
                            textBox9.Focus();
                            codex = false;
        ...
        private void textBox10_TextChanged(object sender, EventArgs e)
        {
            if (textBox10.Text != "")
            {
                ...
                {
                    OdbcConnection conexion = ASG_DB.connectionResult();
                    string sql = string.Format("SELECT ID_CLIENTE FROM CLIENTE WHERE ID_CLIENTE = '{0}';", textBox10.Text);
                    OdbcCommand cmd = new OdbcCommand(sql, conexion);
                    OdbcDataReader reader = cmd.ExecuteReader();
                    if (reader.Read())
                    {

                        //pictureBox5.Image = ASG.Properties.Resources.delete__2_;
                    }
                    else
                    {
        ...
        private bool poseeCuentasPendientes()
        {
            OdbcConnection conexion = ASG_DB.connectionResult();
            try
            {
                
                string sql = string.Format("SELECT ID_CLIENTE FROM CUENTA_POR_COBRAR_CLIENTE WHERE ID_CLIENTE = '{0}' AND ESTADO_CUENTA = TRUE AND ESTADO_TUPLA = TRUE;", textBox10.Text);
                OdbcCommand cmd = new OdbcCommand(sql, conexion);
                OdbcDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!poseeCuentasPendientes())
                {
                    textBox15.Text = textBox13.Text;
                    textBox18.Text = "0";
                } else
                {
                    MessageBox.Show("El Crédito del Cliente no puede ser ajustado debido a que posee cuentas por cobrar pendientes!", "Ajuste Créditos", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            } else
            {
                MessageBox.Show("El Cliente no posee crédito para ajustar!", "Ajuste Créditos", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}
