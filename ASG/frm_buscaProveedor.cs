...
namespace ASG
{
    public partial class frm_buscaProveedor : Form
    {
        ...
        string usuario;
        string idSucursal;
        public frm_buscaProveedor(int indexer, string nameUser, string rolUser, string user, string sucursal)
        {
            InitializeComponent();
            typeData = indexer;
            cargaDatos();
        ...
        {
            var forma = new frm_proveedores(nameUs, rolUs, usuario, 1, idSucursal,true);
            forma.ShowDialog();
        ...
        private void frm_buscaProveedor_Load(object sender, EventArgs e)
        {
