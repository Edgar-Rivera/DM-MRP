...
/// Qwerty Labs 2019
/// Este formulario contiene la vista rapida de lso prvilegios y datos del cliente
/// Recibe como parametro el nombre del usuario que provienen de el evento doble click del datagridview de usuarios
/// se busca el usuario y muestran sus datos mas relevantes
/// </summary>
        ...
        private void getPrivilegios(string id_usuario, string id_rol)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    checkBox18.Checked = reader.GetBoolean(18);
                    checkBox1.Checked = reader.GetBoolean(19);
                    /// Se cargan lso privilegiso de reperotes en esta seccion
                    /// 
                    checkBox36.Checked = reader.GetBoolean(20);
                    checkBox39.Checked = reader.GetBoolean(21);
                    checkBox40.Checked = reader.GetBoolean(22);
                    checkBox41.Checked = reader.GetBoolean(23);
                    checkBox42.Checked = reader.GetBoolean(24);
                    checkBox43.Checked = reader.GetBoolean(25);
                    checkBox44.Checked = reader.GetBoolean(26);
                    checkBox45.Checked = reader.GetBoolean(27);
                    checkBox46.Checked = reader.GetBoolean(28);
                    checkBox47.Checked = reader.GetBoolean(29);
                    checkBox48.Checked = reader.GetBoolean(30);
                    checkBox49.Checked = reader.GetBoolean(31);
                }
            }
            catch (Exception ex)
            {
