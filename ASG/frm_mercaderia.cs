...
namespace ASG
{
    public partial class frm_mercaderia : Form
    {
        ...
        private void cargaMercaderia()
        {
            ...
            {
                OdbcConnection conexion = ASG_DB.connectionResult();
                string sql = string.Format("SELECT * FROM VISTA_MERCADERIA_GENERAL  WHERE SUCURSAL = '{0}' LIMIT 95;",comboBox2.Text);
                OdbcCommand cmd = new OdbcCommand(sql, conexion);
                OdbcDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
        ...
        private void cargaClasificacion(string clasificacion)
        {
            try
            {
                dataGridView1.Rows.Clear();
                OdbcConnection conexion = ASG_DB.connectionResult();
                string sql = string.Format("SELECT * FROM VISTA_MERCADERIA_C WHERE TIPO_MERCADERIA = '{0}' AND NOMBRE_SUCURSAL = '{1}' LIMIT 300;",clasificacion,comboBox2.Text);
                OdbcCommand cmd = new OdbcCommand(sql, conexion);
                OdbcDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                cargaMercaderiaTodo();
            } else if(comboBox1.Text == "ABARROTES")
            {
                cargaClasificacion(comboBox1.Text);
            }
            else if (comboBox1.Text == "ESPECIAS")
            {
                cargaClasificacion(comboBox1.Text);
        ...
        private void cargaMercaderiaInactiva(string sucursal)
        {
            try
            {
                dataGridView1.Rows.Clear();
                OdbcConnection conexion = ASG_DB.connectionResult();
                string sql = string.Format("SELECT * FROM VISTA_MERCADERIA_C  WHERE NOMBRE_SUCURSAL = '{0}'AND  ACTIVO = FALSE;", sucursal);
                OdbcCommand cmd = new OdbcCommand(sql, conexion);
                OdbcDataReader reader = cmd.ExecuteReader();
                if (reader.Read())
                {
                ...
                try
                {
                    ...
                    if (reader.Read())
                    {
                        ...
                        if (reader.Read())
                        {
                            ...
                            getCalculosTotales(textBox4.Text);
                        }
                    }
                    else
                    {
            ...
            { 
                ...
                {  
                    ...
                    if (reader.Read())
                    {
                        ...
                        getCalculoExistenteTraslado(textBox27.Text);
                    }
                } else
                {
                    textBox27.Text = "0";
        ...
        private void textBox26_Leave(object sender, EventArgs e)
        {
            if (textBox26.Text != "")
            {
                getCalculosTotales(textBox26.Text);
            }
        }
                ...
                if (dataGridView3.RowCount > 0)
                {
                    ...
                    for (int i = 0; i < dataGridView3.RowCount; i++)
                    {
                        ...
                        if (tipoTraslado == "1")
                        {
                            ...
                            if (tempX > 0)
                            {
                                dataGridView3.Rows[i].Cells[3].Value = string.Format("{0:###,###,###,##}", tempX);
                            }
                            else
                            {
                        ...
                        {
                            dataGridView3.Rows[i].Cells[3].Value = string.Format("{0:###,###,###,##0.00##}", Math.Round(temp / Convert.ToDouble(dataGridView3.Rows[i].Cells[2].Value.ToString()), 2));
                        }
                    }
                }
        ...
        private void getCalculosTotales(string existencia)
        {
            if (Convert.ToDouble(existencia) > 0)
            {
                // la cantidad del prudcto es maor a 0
                if (dataGridView4.RowCount > 0)
                {
                    ...
                    for (int i = 0; i < dataGridView4.RowCount; i++)
                    {
                        ...
                        {
                            dataGridView4.Rows[i].Cells[3].Value = string.Format("{0:###,###,###,##0.00##}", Math.Round(temp / Convert.ToDouble(dataGridView1.Rows[i].Cells[2].Value.ToString()), 2));
                        }
                    }
                }
