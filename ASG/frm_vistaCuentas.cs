...
namespace ASG
{
    public partial class frm_vistaCuentas : Form
    {
        Point DragCursor;
        Point DragForm;
        bool Dragging;

        public frm_vistaCuentas()
        {
            InitializeComponent();
            cargaDatos();
        ...
        private void Frm_vistaCuentas_MouseDown(object sender, MouseEventArgs e)
        {
            Dragging = true;
        ...
        private void Frm_vistaCuentas_MouseMove(object sender, MouseEventArgs e)
        {
            if (Dragging == true)
            {
        ...
        private void Frm_vistaCuentas_MouseUp(object sender, MouseEventArgs e)
        {
            Dragging = false;
        }
        ...
        private void Frm_vistaCuentas_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frm_vistaCuentas_Load(object sender, EventArgs e)
        {
