...
namespace ASG
{
    public partial class frm_buscaMateriaPrima : Form
    {
        Point DragCursor;
        Point DragForm;
        bool Dragging;
        string codigo;
        string sucursal;
        public frm_buscaMateriaPrima(string sucursalActual, string rol, bool temp)
        {
            InitializeComponent();
            cargaSucursales();
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if(dataGridView1.RowCount > 0)
            {
                ...
                sucursal = dataGridView1.CurrentRow.Cells[5].Value.ToString();
